...
print("\n--- MÉTRICAS TEST TEMPORAL CONTACTO ---")
...
print("\n--- LIFT POR DECILES CONTACTO - TEST TEMPORAL ---")
print(tabla)
tabla.to_csv("lift_deciles_contacto_temporal.csv")

os.makedirs(OUT_FIG_DIR, exist_ok=True)

plt.figure(figsize=(9, 5))
plt.bar(tabla.index.astype(str), tabla["tasa_descuelgue"])
plt.title("Tasa de descuelgue por decil - test temporal (1 = TOP)")
plt.xlabel("Decil")
plt.ylabel("Tasa de descuelgue")
plt.tight_layout()
plt.savefig(os.path.join(OUT_FIG_DIR, "temporal_tasa_descuelgue_por_decil.png"), dpi=200, bbox_inches="tight")
plt.show()
