...
# En contacto usamos toda la población.
...
print(f"Filas usadas para inferencia contacto: {len(df_model):,}")
print(f"Tasa base contacto: {df_model[TARGET].mean():.6f}")
...
print("\nODDS RATIOS / COEFICIENTES CONTACTO")
