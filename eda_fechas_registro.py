...
SCORE_CONTACTO = "pr_contact"
SCORE_VENTA_POST_CONTACTO = "pr_venta_2026"
SCORE_FINAL_PRECONTACTO = "pr_final_venta"
...
df["dias_desde_crea_reg"] = (
    df["fe_test_dt"] - df["fe_crea_reg_dt"]
).dt.days
...
print("\nResumen conceptual:")
print("- pr_contact debe evaluarse contra target_descuelgue_calc en toda la población.")
print("- pr_venta_2026 debe evaluarse contra ganada SOLO entre contactados.")
print("- pr_final_venta debe evaluarse contra ganada en toda la población.")
