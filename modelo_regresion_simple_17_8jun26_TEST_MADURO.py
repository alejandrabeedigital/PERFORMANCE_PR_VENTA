...
print("\n--- MÉTRICAS TEST MADURO VENTA POST-CONTACTO ---")
...
print("\n--- LIFT POR DECILES VENTA POST-CONTACTO - TEST MADURO ---")
print(tabla)
...
plt.title("Tasa de venta post-contacto por decil - test maduro (1 = TOP)")
plt.xlabel("Decil")
plt.ylabel("Tasa de venta")
plt.tight_layout()
plt.savefig(
    os.path.join(OUT_FIG_DIR, "maduro_tasa_venta_postcontacto_por_decil.png"),
    dpi=200,
    bbox_inches="tight",
)
plt.show()

tabla.to_csv("lift_deciles_venta_postcontacto_maduro.csv")
