...
def add_common_features(df):
    ...
    df['registro_nuevo_7d'] = np.where(df['dias_desde_crea_reg'].le(7), 'SI', 'NO')
    ...
    for c in [
        ...
        'origen_sc_o_no', 'sin_gmb', 'gmb_sin_owner', 'sin_intentos_recientes',
        'ant_empresa', 'algun_contacto', 'registro_nuevo_7d', 'registro_nuevo_30d',
        'registro_nuevo_90d', 'bucket_dias_crea_reg', 'tiene_reactivacion', 'origen',
        'ct_sociedad', 'co_actvad'
    ]:
        if c in df.columns:
